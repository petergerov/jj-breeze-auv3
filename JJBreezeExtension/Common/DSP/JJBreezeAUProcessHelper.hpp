...
#include <vector>
#include <algorithm>
#include "JJBreezeDSPKernel.hpp"
#include "JJBreezeBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(JJBreezeDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
