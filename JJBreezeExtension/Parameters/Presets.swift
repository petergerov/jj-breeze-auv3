...
enum FactoryPresets {
    static let all: [FactoryPreset] = [
        ...
        FactoryPreset(number: 3, name: "JJ Dark Vocal",
                      ...
                      shiftOn: true, slapOn: false, vibratoOn: true, warmthOn: true),
        ...
        FactoryPreset(number: 5, name: "Octave Width",
                      ...
                      warmthTone: 3500, warmthDrive: 20, warmthBody: 0, warmthMix: 0,
                      shiftOn: true, slapOn: false, vibratoOn: false, warmthOn: false),
        FactoryPreset(number: 6, name: "Slapback Twang",
                      pitchL: 0, pitchR: 0, delayL: 15, delayR: 15, focus: 150, mix: 0,
                      slapTime: 110, slapFeedback: 25, slapMix: 35,
                      vibratoRate: 1.2, vibratoDepth: 3.0, vibratoMix: 0,
                      warmthTone: 3500, warmthDrive: 20, warmthBody: 0, warmthMix: 0,
                      shiftOn: false, slapOn: true, vibratoOn: false, warmthOn: false),
        FactoryPreset(number: 7, name: "Deep Baritone",
                      ...
                      shiftOn: true, slapOn: false, vibratoOn: false, warmthOn: true)
    ]
}
